...
export const MODEL_SHORTCUTS: readonly ModelShortcut[] = [
	{ key: "ctrl+1", fallbackKey: "alt+1", provider: "github-copilot", model: "gpt-6-astra", thinkingLevel: "max" },
	{ key: "ctrl+2", fallbackKey: "alt+2", provider: "github-copilot", model: "gpt-5.6-sol", thinkingLevel: "max" },
	{ key: "ctrl+3", fallbackKey: "alt+3", provider: "github-copilot", model: "gpt-5.6-luna", thinkingLevel: "max" },
	{ key: "ctrl+4", fallbackKey: "alt+4", provider: "openai-codex", model: "gpt-6-astra", thinkingLevel: "max" },
	{ key: "ctrl+5", fallbackKey: "alt+5", provider: "openai-codex", model: "gpt-5.6-sol", thinkingLevel: "max" },
	{ key: "ctrl+6", fallbackKey: "alt+6", provider: "openai-codex", model: "gpt-5.6-luna", thinkingLevel: "max" },
];
...
export function installModelShortcuts(
	...
	for (const shortcut of shortcuts) {
		...
		for (const key of [shortcut.key, shortcut.fallbackKey]) {
